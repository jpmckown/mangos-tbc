...
namespace MaNGOS
{
    ...
    {
        public:
            AsyncSocket(boost::asio::io_context& io_service);
            virtual ~AsyncSocket();
    ...
    template <typename SocketType>
    MaNGOS::AsyncSocket<SocketType>::AsyncSocket(boost::asio::io_context& io_service) : m_socket(io_service), m_address("0.0.0.0"),
